...
// 			// $("#blah").find("src").html(url);
// 			$('#blah').attr('href', url);
//             console.log('========$(#blah).attr(href, url);========='+url)
...
// 		// getBase64Image(photo, function(dataUrl) {
// 		// 	console.log('RESULT:', dataUrl)

//         // })
//         setTimeout(function(){ 
//             download();
//             // document.getElementById("getHashImg").innerHTML= url
//             // document.getElementById("hash").value= url

//             // $('#getHashImg').attr('ng-init', url);
//         }, 2000);
...
//     console.log("-----------------------------------------------------------getDataurl-------------------------------"+dataURL)
